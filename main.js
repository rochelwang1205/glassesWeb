...
const imageModules = import.meta.glob('/assets/image/series-products/*.png', { eager: true });
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    Object.keys(imageModules).forEach(path => {
        ...
        if (fileName.startsWith(baseFileName)) {
            if (fileName.includes('sunglasses')) {
                sunglassesImageUrls.push(imageModules[path].default);
            } else {
                opticalImageUrls.push(imageModules[path].default);
            }
        }
    });
